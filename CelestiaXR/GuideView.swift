...
struct GuideView: UIViewControllerRepresentable {
    ...
    func makeUIViewController(context: Context) -> CommonWebViewController {
        return CommonWebViewController(executor: renderer, resourceManager: resourceManager, url: .fromGuide(guideItemID: id, language: AppCore.language), actionHandler: { action, viewController in
