...
struct AddonCategoriesView: UIViewControllerRepresentable {
    ...
    func makeUIViewController(context: Context) -> UINavigationController {
        ...
        return UINavigationController(rootViewController: CommonWebViewController(executor: renderer, resourceManager: resourceManager, url: url, actionHandler: { _, _ in }, filterURL: false))
    }
