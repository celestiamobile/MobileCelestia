...
struct ToolView: View {
    ...
    init(userDefault: UserDefaults, bundle: Bundle, defaultDataDirectory: URL, defaultConfigFile: URL, userDirectory: URL, resourceManager: ResourceManager, requestHandler: RequestHandler) {
    ...
    var body: some View {
        Group {
            ...
            case .downloadAddons:
                AddonCategoriesView(resourceManager: resourceManager, requestHandler: requestHandler)
            case .goTo:
                GoToView()
            case .eclipseFinder:
                EclipseFinder()
            ...
            case .help:
                HelpView(resourceManager: resourceManager, requestHandler: requestHandler)
            }
        }
    }
}
