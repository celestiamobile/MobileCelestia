...
struct ToolView: View {
    ...
    init(
        ...
        bundle: Bundle, defaultDataDirectory: URL,
    ...
    var body: some View {
        Group {
            ...
            case .currentTime:
                TimeSettingsView(featureFlags: featureFlags)
            case .settings:
                SettingsView(userDefault: userDefaults, bundle: bundle, defaultDataDirectory: defaultDataDirectory, defaultConfigFile: defaultConfigFile, assetProvider: assetProvider, featureFlags: featureFlags)
            case .help:
