...
- (instancetype)initWithEGLColorImage:(EGLImageKHR)eglColorImage eglDepthImage:(EGLImageKHR)eglDepthImage glColorTexture:(GLuint)glColorTexture glDepthTexture:(GLuint)glDepthTexture glIntermediateColorTexture:(GLuint)glIntermediateColorTexture glFramebuffer:(GLuint)glFramebuffer width:(GLint)width height:(GLint)height {
    self = [super init];
    if (self) {
