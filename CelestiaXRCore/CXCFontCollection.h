...
@property (readonly) CXCFont *mainFont;
@property (readonly) CXCFont *titleFont;
@property (readonly) CXCFont *normalRenderFont;
@property (readonly) CXCFont *largeRenderFont;
