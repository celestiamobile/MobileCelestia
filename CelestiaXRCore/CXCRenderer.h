...
@property (nullable, nonatomic) void (^stateUpdater)(CelestiaAppState *);
@property (nullable, nonatomic) void (^statusUpdater)(CXCRendererStatus);
@property (nullable, nonatomic) void (^fileNameUpdater)(NSString *);
@property (nullable, nonatomic) void (^messageUpdater)(NSString *);

@property (readonly, nonatomic) CelestiaAppCore *appCore;

- (instancetype)init NS_UNAVAILABLE;
- (instancetype)initWithResourceFolderPath:(NSString *)resourceFolderPath configFilePath:(NSString *)configFilePath extraDirectories:(NSArray<NSString *> *)extraDirectories userDefaults:(NSUserDefaults *)userDefaults appDefaultsPath:(nullable NSString *)appDefaultsPath defaultFonts:(CXCFontCollection *)defaultFonts otherFonts:(NSDictionary<NSString *, CXCFontCollection *> *)otherFonts antiAliasing:(BOOL)antiAliasing;
