...
public class SettingCommonViewController: BaseTableViewController {
    ...
    public init(core: AppCore, executor: AsyncProviderExecutor, userDefaults: UserDefaults, item: SettingCommonItem) {
        self.item = item
        self.core = core
